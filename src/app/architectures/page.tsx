...
export const metadata: Metadata = {
  title: "20 Specialized Trading Bot Dashboard Architectures | Algorb",
  description:
  ...
  return (
    <div className="flex flex-col w-full pt-28 pb-20">
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full text-center space-y-6 pb-12">
        ...
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold font-mono tracking-tight text-white max-w-5xl mx-auto leading-tight sm:leading-none">
          20 SPECIALIZED ARCHITECTURES. <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent via-white to-accent/80">
            ZERO GENERIC DASHBOARDS.
          </span>
        </h1>

        <p className="text-sm sm:text-base text-text-secondary max-w-3xl mx-auto font-sans leading-relaxed">
          Generic SaaS dashboards fail algorithmic traders. A mempool sniper requires gas priority queues, not multi-year candlestick charts. A prop trader lives or dies by the <span className="text-white font-mono font-bold">Daily Drawdown Halo</span>. Explore 20 distinct, purpose-built architectures ready to connect directly to your execution engine.
        </p>

        {/* Feature Badges Strip */}
        <div className="flex flex-wrap items-center justify-center gap-3 pt-2 font-mono text-xs text-text-muted">
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-white/10 bg-white/[0.02]">

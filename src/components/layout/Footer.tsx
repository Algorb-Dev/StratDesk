...
export const Footer: React.FC = () => {
  return (
    <footer className="relative bg-background-secondary border-t border-border pt-16 pb-12 overflow-hidden select-none">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-border">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 font-mono text-xs text-text-muted mt-2">
              <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-slate-200/60 dark:bg-white/5 border border-border">
          ...
          <div className="flex flex-col gap-3 font-mono text-xs">
            <span className="font-bold text-slate-900 dark:text-white uppercase tracking-widest text-[11px] mb-1">
              Products
            </span>
            <Link
              href="/"
            ...
            >
              <span>StratDesk Pro</span>
              <span className="text-[9px] text-warning/80 font-normal ml-1">Command Center</span>
            </Link>
            <Link
              href="/docs"
              className="text-text-secondary hover:text-accent transition-colors flex items-center gap-1 group"
            ...
            >
              ...
              <span className="text-[9px] text-accent/80 font-normal ml-1">Unlocked</span>
            </Link>
            <Link
              href="/ledger"
              className="text-text-secondary hover:text-accent transition-colors flex items-center gap-1 group"
            >
              ...
              <span className="text-[9px] text-accent font-semibold ml-1">Forensic Audit</span>
            </Link>
            <Link
              href="/#themes"
          ...
          <div className="flex flex-col gap-3 font-mono text-xs">
            ...
            <a
              href="mailto:stratdesk.pro@gmail.com"
              className="text-text-secondary hover:text-accent transition-colors"
            >
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-xs text-text-muted">
          <div>
            © {new Date().getFullYear()} StratDesk. All rights reserved. Built for autonomous systems.
          </div>

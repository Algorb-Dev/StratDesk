      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-base sm:text-lg text-text-secondary leading-relaxed">
            Algorb never asks for your exchange API private keys, never proxies your live order execution, and never stores your alpha code on external servers.
          </p>
        </div>

        {/* Visual Architecture Flow Diagram */}
        <div className="relative max-w-5xl mx-auto rounded-2xl bg-surface/90 border border-white/10 p-6 sm:p-10 font-mono text-xs shadow-2xl">
          {/* Top Security Banner */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 my-8 relative">
            ...
            <div className="p-5 rounded-xl bg-background border border-white/10 flex flex-col justify-between hover:border-white/25 transition-colors group">
              <div>
                <div className="flex items-center justify-between text-[10px] text-text-muted mb-2">
                  <span>CUSTOMER INFRA</span>
                  <span className="text-white font-bold">01</span>
                </div>
                <div className="font-bold text-sm text-white font-sans group-hover:text-accent transition-colors">
                  YOUR STRATEGY
                </div>
              ...
              <div className="mt-4 pt-3 border-t border-white/5 flex items-center gap-1 text-[10px] text-text-muted">
            ...
            <div className="p-5 rounded-xl bg-accent/10 border-2 border-accent/60 flex flex-col justify-between shadow-glow-cyan">
              <div>
                ...
                <div className="font-bold text-sm text-white font-sans flex items-center gap-2">
                  <AlgorbSymbol size={18} />
                  <span>ALGORB INTERFACE</span>
                </div>
                <p className="mt-2 text-[11px] text-text-secondary font-sans leading-relaxed">
                  Local WebSocket telemetry bridge that renders high-density visual dashboards and optional command triggers.
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-accent/20 flex items-center gap-1 text-[10px] text-accent font-bold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-6 border-t border-white/10 text-xs text-text-secondary font-sans">
            <div>
              <span className="font-bold text-white block mb-1">Zero Lock-In</span>
              If you turn off Algorb, your bot continues trading without disruption. It has zero dependency on Algorb staying online.
            </div>
            <div>
              <span className="font-bold text-white block mb-1">Local Loopback</span>
              By default, the telemetry adapter binds to `127.0.0.1:9042`. No internet connection required for local monitoring.
            </div>
            <div>
              <span className="font-bold text-white block mb-1">Encrypted Remote</span>
